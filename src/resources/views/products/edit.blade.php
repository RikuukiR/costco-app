...
<div class="container">
    ...
    <form action="{{ route('products.update', $product) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="spec_code" name="spec_code" value="{{ $product->spec_code }}" disabled>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="target_weight" name="target_weight" value="{{ old('target_weight', $product->target_weight) }}" required>
        </div>
        <div class="mb-3">
            <label for="image_path" class="form-label">商品画像パス</label>
            <input type="text" class="form-control" id="image_path" name="image_path" value="{{ old('image_path', $product->image_path) }}">
        </div>
